...
const EmployeeDirectoryPage = () => {
  ...
  const [newEmployee, setNewEmployee] = useState({
    ...
    address: { street: '', city: 'Bangalore', state: 'Karnataka', zip: '' },
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-400 text-sm mt-1">
            Manage organization staff, departmental structures, and onboarding workflows.
          </p>
        </div>
      ...
      <div className="p-4 rounded-2xl bg-slate-900/80 border border-slate-800 flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="relative w-full md:w-80">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 bg-slate-950/80 border border-slate-800 rounded-xl text-white placeholder-slate-500 text-xs focus:ring-2 focus:ring-brand-500 focus:outline-none"
          />
        </div>
        ...
        <div className="flex flex-wrap items-center gap-3 w-full md:w-auto">
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="px-3 py-2 bg-slate-950/80 border border-slate-800 rounded-xl text-xs text-white focus:ring-2 focus:ring-brand-500 focus:outline-none"
            >
                ...
                {employees.map((emp) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      ...
                      <div className="text-[11px] text-slate-400 mt-0.5">{emp.designation}</div>
                    </td>
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-2 text-slate-300">
                        <span className="px-2 py-0.5 rounded bg-slate-800 text-[11px]">
                          Paid: <strong className="text-emerald-400">{emp.leaveBalance?.paid || 0}</strong>
                        </span>
                        <span className="px-2 py-0.5 rounded bg-slate-800 text-[11px]">
                          Sick: <strong className="text-brand-400">{emp.leaveBalance?.sick || 0}</strong>
                        </span>
                      </div>
                    </td>
                    ...
                    <td className="px-6 py-4 text-right">
                      <div className="flex items-center justify-end gap-1.5">
                        ...
                        <button
                          ...
                          title="Edit Details"
                          className="p-1.5 rounded-lg bg-brand-600/20 hover:bg-brand-600 text-brand-300 hover:text-white transition-all"
                        >
            ...
            <div className="flex items-center justify-between border-b border-slate-800 pb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400">Add team member to Dayflow workforce</p>
                </div>
              </div>
              <button
            ...
            <form onSubmit={handleCreateEmployee} className="space-y-4 text-xs">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="robert@dayflow.com"
                    className="w-full px-3.5 py-2.5 rounded-xl bg-slate-950 border border-slate-800 text-white focus:ring-2 focus:ring-brand-500 focus:outline-none"
                  />
                </div>
              ...
              <div className="pt-3 border-t border-slate-800">
                <span className="font-bold text-slate-300 uppercase tracking-wider block mb-2">
                  Initial Leave Balance Allocation
                </span>
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-slate-400 mb-1">Paid Leaves (Days)</label>
                    <input
                      type="number"
                      value={newEmployee.leaveBalance.paid}
                      onChange={(e) =>
                        setNewEmployee({
                          ...newEmployee,
                          leaveBalance: {
                            ...newEmployee.leaveBalance,
                            paid: Number(e.target.value),
                          },
                        })
                      }
                      className="w-full px-3.5 py-2 rounded-xl bg-slate-950 border border-slate-800 text-white focus:ring-2 focus:ring-brand-500 focus:outline-none"
                    />
                  </div>
                  <div>
                    <label className="block text-slate-400 mb-1">Sick Leaves (Days)</label>
                    <input
                      type="number"
                      value={newEmployee.leaveBalance.sick}
                      onChange={(e) =>
                        setNewEmployee({
                          ...newEmployee,
                          leaveBalance: {
              ...
              <div className="pt-3 border-t border-slate-800">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      type="number"
                      value={selectedEmployee.leaveBalance?.paid || 0}
                      onChange={(e) =>
                        setSelectedEmployee({
                          ...selectedEmployee,
                          leaveBalance: {
                  ...
                  <div>
                    ...
                    <input
                      type="number"
                      value={selectedEmployee.leaveBalance?.sick || 0}
                      onChange={(e) =>
                        setSelectedEmployee({
                          ...selectedEmployee,
                          leaveBalance: {
            ...
            <div className="space-y-4 text-xs">
              <div className="grid grid-cols-2 gap-3 p-4 rounded-2xl bg-slate-950/80 border border-slate-800">
                ...
                <div>
                  ...
                  <div className="text-white font-semibold mt-0.5">{selectedEmployee.email}</div>
                </div>
                <div>
              ...
              <div className="p-4 rounded-2xl bg-slate-950/80 border border-slate-800 flex items-center justify-between">
                <div>
                  <span className="text-slate-400 font-medium">Paid Leaves</span>
                  <div className="text-lg font-bold text-emerald-400">
                    {selectedEmployee.leaveBalance?.paid || 0} days
                  </div>
                </div>
                <div>
                  <span className="text-slate-400 font-medium">Sick Leaves</span>
                  <div className="text-lg font-bold text-brand-400">
                    {selectedEmployee.leaveBalance?.sick || 0} days
                  </div>
                </div>
                <div>
                  <span className="text-slate-400 font-medium">Total Available</span>
