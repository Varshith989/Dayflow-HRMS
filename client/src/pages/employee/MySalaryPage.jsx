    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        {payslips.length > 0 && (
          <div className="flex items-center gap-2 px-3.5 py-2 bg-slate-900 border border-slate-800 rounded-2xl shadow-card">
            ...
            <span className="text-xs text-slate-400 font-medium">Select Cycle:</span>
            <select
      ...
      {loading ? (
        ...
        <div className="p-12 text-center text-slate-400 rounded-3xl bg-slate-900 border border-slate-800">
          ...
          <p className="text-sm font-semibold text-white">No Payslip Records Found</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
            ...
            <div className="p-5 rounded-2xl bg-slate-900/80 border border-slate-800 flex items-center justify-between">
              <div>
                ...
                <span className="text-[11px] text-slate-500 mt-0.5 block">Base + All Allowances</span>
              </div>
            ...
            <div className="p-5 rounded-2xl bg-slate-900/80 border border-slate-800 flex items-center justify-between">
              <div>
                ...
                <span className="text-[11px] text-slate-500 mt-0.5 block">PF & Statutory Taxes</span>
              </div>
          ...
          <div className="rounded-3xl bg-slate-900/90 border border-slate-800 p-6 sm:p-10 shadow-2xl space-y-8">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b border-slate-800 pb-6">
              ...
              <div className="text-right">
                <span className="text-xs font-mono font-bold px-3 py-1 rounded-xl bg-slate-950 border border-slate-800 text-brand-300">
                  SLIP-REF: DF-{selectedPayslip.year}{String(selectedPayslip.month).padStart(2, '0')}-{selectedPayslip.userId?.employeeId || 'EMP'}
                </span>
                <p className="text-[11px] text-slate-500 mt-1.5">Confidential Compensation Document</p>
              </div>
            </div>

            {/* Employee Particulars Grid */}
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 p-5 rounded-2xl bg-slate-950/80 border border-slate-800 text-xs">
              <div>
                <span className="text-slate-500 font-semibold block uppercase">Employee Name</span>
                <span className="text-white font-bold text-sm mt-0.5 block">
                  {selectedPayslip.userId?.name}
                </span>
              </div>
              <div>
                <span className="text-slate-500 font-semibold block uppercase">Employee ID</span>
                <span className="text-slate-200 font-mono font-bold mt-0.5 block">
                  {selectedPayslip.userId?.employeeId}
                </span>
              </div>
              <div>
                <span className="text-slate-500 font-semibold block uppercase">Department</span>
                <span className="text-slate-200 font-medium mt-0.5 block">
                  {selectedPayslip.userId?.department}
                </span>
              </div>
              <div>
                <span className="text-slate-500 font-semibold block uppercase">Designation</span>
                <span className="text-slate-200 font-medium mt-0.5 block">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 text-xs">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between border-b border-emerald-500/30 pb-2">
                  ...
                  <span className="text-slate-500 font-semibold uppercase">Amount (INR)</span>
                </div>

                <div className="space-y-2">
                  <div className="flex justify-between py-1 text-slate-300 border-b border-slate-800/60">
                  ...
                  <div className="flex justify-between py-2.5 text-emerald-400 font-bold text-sm pt-2">
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between py-2.5 text-rose-400 font-bold text-sm pt-2">
            ...
            <div className="p-6 rounded-2xl bg-gradient-to-r from-brand-950/60 via-slate-950 to-indigo-950/60 border border-brand-500/30 flex flex-col sm:flex-row items-center justify-between gap-4">
              <div>
                <span className="text-xs font-bold text-brand-300 uppercase tracking-wider block">
                  Net Salary Payable in Account
                </span>
                <span className="text-xs text-slate-400 mt-0.5 block">
                  {selectedPayslip.remarks || 'Standard monthly disbursement'}
                </span>
              </div>
